...
void EntityManager::createSounds() {
    shotSound = sf::Sound(ResourceManager::getSoundBuffer("../Sound/shot.wav"));
    bombSound = sf::Sound(ResourceManager::getSoundBuffer("../Sound/bomb.wav"));
    mainTheme = sf::Sound(ResourceManager::getSoundBuffer("../Sound/Music.wav"));
